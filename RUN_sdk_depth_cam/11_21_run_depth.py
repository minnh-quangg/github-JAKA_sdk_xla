...
# điều khiển robot
def pick_objects(P_EE_cam, Rotation_ojb2cam, speed, acc, tol,delay):
    ...
    p_truoctha=deg_to_rad([56.571, 54.624, 30.106, -0.507, 94.613, -185.325])
    ...
    # time.sleep(delay)
      # vị trí thả
    robot.joint_move_extend(joint_pos=p_target, move_mode=0, is_block=True, speed=speed, acc=acc, tol=tol)
      # tắt hút
...
if __name__ == "__main__":
    ...
    if pose is None:
        ...
        ret = pick_objects(P_cam, R_cam, speed=4, acc=1, tol=0.1,delay=0.5)
