...
def pick_objects(P_EE_cam, Rotation_ojb2cam, speed=100, acc=20, tol=1):
    ...
    robot.joint_move_extend(joint_pos=joint_pose1, move_mode=0, is_block=True, speed=1, acc=0.25, tol=0.1)
    time.sleep(1)
    robot.joint_move_extend(joint_pos=joint_pose2, move_mode=0, is_block=True, speed=1, acc=0.25, tol=0.1)
    # print(ret)
    # time.sleep(100)
    ...
    time.sleep(1)
    robot.joint_move_extend(joint_pos=p_temp, move_mode=0, is_block=True, speed=1, acc=0.25, tol=0.1)
    time.sleep(1)
    robot.joint_move_extend(joint_pos=p_target, move_mode=0, is_block=True, speed=1, acc=0.25, tol=0.1)
