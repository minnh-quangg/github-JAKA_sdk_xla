...
def pick_objects(P_EE_cam, Rotation_ojb2cam, speed, acc, tol,delay, ID):
    ...
    P_EE_1= T @ p
    P_EE_2= P_EE_1[:3,0]
    r_UCS = [math.radians(-178.647),math.radians(0.005),math.radians(-90.360)]
    ...
    p_truoctha=deg_to_rad([83.65, 59.416, 29.712, -0.745, 90.807, -136.095])
    if ID == 3:
        z = 20
    elif ID == 2:
        z = 10
...
if __name__ == "__main__":
    ...
    if pose is None:
        ...
        ret = pick_objects(P_cam, R_cam, speed=4, acc=1, tol=0.1,delay=0.5,ID=marker_ID)
