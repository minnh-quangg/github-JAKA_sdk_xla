...
# Chiều dài cạnh marker (m) – chỉnh đúng với cỡ bạn in
marker_length = 0.05  # 5 cm = 0.05 m
...
if __name__ == "__main__":
    ...
    if pose is None:
        ...
        print('góc rad từ vật về cam',rx_rad,ry_rad,rz_rad)

        rx_rad,ry_rad,rz_rad=convert_camera_to_base_rotation(math.degrees(rx_rad),math.degrees(ry_rad),math.degrees(rz_rad))
        print('góc rad từ vật về UCS',rx_rad,ry_rad,rz_rad)
        ...
        print('vị trí chạy',x_cam_mm,y_cam_mm,z_cam_mm)
        R_cam = np.array([rx_rad, ry_rad,rz_rad])
        print('góc chạy',rx_rad,ry_rad,rz_rad)
