...
def pick_objects(P_EE_cam, Rotation_ojb2cam, speed, acc, tol,delay, ID):
    ...
    robot.joint_move_extend(joint_pos=p_home, move_mode=0, is_block=True, speed=speed, acc=acc, tol=tol) #### HOME 
...
if __name__ == "__main__":
    ...
    # elif i == 2
        if  z == 10:
            ...
            p_truocluuvat2=deg_to_rad([49.382, 56.817, 36.238, -0.153, 86.402, -84.321])
            p_luuvat2=deg_to_rad([49.418, 57.733, 39.910, -0.155, 81.815, -84.272])
            p_home=deg_to_rad([15.041, 16.657, 60.623, -0.226, 101.920, -207.417])
